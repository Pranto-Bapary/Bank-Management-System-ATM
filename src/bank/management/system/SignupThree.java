...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formNo){
        ...
        JLabel cardNumber = new JLabel("XXXX-XXXX-XXXX-2113");
        cardNumber.setFont(new Font("Raleway",Font.BOLD,22));
        cardNumber.setBounds(330,180,300,30);
        add(cardNumber);
        
        JLabel cardDetails = new JLabel("Your 16 Digit Card Number");
        cardDetails.setFont(new Font("Raleway",Font.BOLD,12));
        cardDetails.setBounds(100,210,300,20);
        add(cardDetails);
        ...
        pinDetails.setBounds(100,280,300,20);
        add(pinDetails);
        
        JLabel pinNumber=new JLabel("XXXX");
        pinNumber.setFont(new Font("Raleway",Font.BOLD,22));
        pinNumber.setBounds(330,250,200,30);
        add(pinNumber);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == submit){
            ...
            String cardNumber = "" + Math.abs((random.nextLong() % 90000000L) + 2210020000000000L);
