...
public class Deposit extends JFrame implements ActionListener{
    ...
    Deposit(String pinNumber){
        ...
        JLabel amountText = new JLabel("Enter the amount you want to Deposit: ");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == deposit){
            ...
            if(depositAmount.equals("")){
                JOptionPane.showMessageDialog(null, "Kindly Enter the amount you want to deposit");
            }else{
                ...
                try{
                    ...
                    JOptionPane.showMessageDialog(null, "Taka " + depositAmount + " Deposited Successfully");
                    setVisible(false);
